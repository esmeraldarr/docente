package {
	...
	public class proyecto_abc extends Sprite
	{
        ...
        private function onFlarManagerInited (evt:Event) :void 
        {
            ...
            model.load("./assets/models/A/A.DAE"); 
            model.rotationX = 90; 
            model.rotationY = 0; 
            model.rotationZ = 90; 
            model.scale = 1; 
            ...
            model1.load("./assets/models/B/B.DAE"); 
            model1.rotationX = 90; 
            model1.rotationY = 0;
            model1.rotationZ = 90; 
            model1.scale = 1;
            ...
            model2.load("./assets/models/C/C.DAE"); 
            model2.rotationX = 90; 
            model2.rotationY = 0;
            model2.rotationZ = 90; 
            model2.scale = 1; 
            ...
            model3.load("./assets/models/D/D.dae"); 
            model3.rotationX = 90; 
            model3.rotationY = 0;
            model3.rotationZ = 90; 
            model3.scale = 1;
			...
			model4.load("./assets/models/E/E.dae"); 
			model4.rotationX = 90; 
			model4.rotationY = 0;
			model4.rotationZ = 90; 
			model4.scale = 1;
			...
			model5.load("./assets/models/F/F.dae"); 
			model5.rotationX = 90; 
			model5.rotationY=  0;
			model5.rotationZ = 90; 
			model5.scale = 1; 
			...
			model6.load("./assets/models/G/G.DAE"); 
			model6.rotationX = 90; 
			model6.rotationY=  0;
			model6.rotationZ = 90; 
			model6.scale = 1; 
			...
			model7.load("./assets/models/figuras/arbol/arbol.DAE"); 
			model7.rotationX = 90; 
			model7.rotationY = 0;
			model7.rotationZ = 90; 
			model7.scale = 1; 
			...
			model8.load("./assets/models/figuras/avion/avion.dae"); 
			model8.rotationX = 90; 
			model8.rotationY = 0;
			model8.rotationZ = 0; 
			model8.scale = 1; 
			...
			model9.load("./assets/models/figuras/bate/bate.DAE"); 
			model9.rotationX = 90; 
			model9.rotationY = 0;
			model9.rotationZ = 0; 
			model9.scale = 1; 
			...
			model10.load("./assets/models/figuras/bote/bote.dae"); 
			model10.rotationX = 90; 
			model10.rotationY = 0;
			model10.rotationZ = 90; 
			model10.scale = 1; 
			
			model11 = new DAE(true, "model11", true); 
			model11.load("./assets/models/figuras/carro/CARRO.DAE"); 
			...
			model12.load("./assets/models/figuras/casa/casa.dae"); 
			...
			model13.load("./assets/models/figuras/dados/dados.dae");
			...
			model14.load("./assets/models/figuras/dos/DOS.DAE");
			model14.rotationX = 90;
			model14.rotationY = 0;
			model14.rotationZ = 90;
			model14.scale = 1;
			
			model15 = new DAE(true, "model15", true);
			model15.load("./assets/models/figuras/escalera/escaleras.dae");
			model15.rotationX = 90;
			model15.rotationY = 0;
			model15.rotationZ = -90;
			model15.scale = 1;
			
			model16 = new DAE(true, "model16", true);
			model16.load("./assets/models/figuras/estrella/estrella.dae");
			...
			model17.load("./assets/models/figuras/flores/flores.dae");
			...
			model18.load("./assets/models/figuras/frutas/frutas.dae");
			...
			model19.load("./assets/models/figuras/gato/gato.dae");
			...
			model20.load("./assets/models/figuras/globo/globo.dae");
   ...
   //-------------------------------INICIO DEL TEXTO QUE SE INCLUIRA EN CADA UNO DE LOS BOTONES----------------------------//		
	...
	//----------AGREGAMOS LOS addEventListener CORRESPONDIENTES A CADA UNO DE LOS EVENTOS QUE VAMOS A HACER CON LOS BOTONES------//	
	    ...
	    function updateP(e:KeyboardEvent):void {
			switch( e.keyCode )
			{
				case "W".charCodeAt():
				case Keyboard.UP:
			...
			private function onMarkerAdded ( evt:FLARMarkerEvent) :void
			{
					...
					if(evt.marker.patternId == 0)
					{
    						...
    						sound = new Sound;
							sound.load(new URLRequest("./assets/sonido/letras/letra_a.mp3"));
					...
					if(evt.marker.patternId == 1)
				{
					 ...
					 sound1 = new Sound;
					 sound1.load(new URLRequest('./assets/sonido/letras/letra_b.mp3'));
				...
				if(evt.marker.patternId == 2)
				{
					 ...
					 sound2 = new Sound;
					 sound2.load(new URLRequest('./assets/sonido/letras/letra_c.mp3'));
				...
				if(evt.marker.patternId == 3)
				{
					 ...
					 sound3 = new Sound;
					 sound3.load(new URLRequest('./assets/sonido/letras/Letra_D.mp3'));
				...
				if(evt.marker.patternId == 4)
				{
					 ...
					 sound4 = new Sound;
					 sound4.load(new URLRequest('./assets/sonido/letras/Letra_E.mp3'));
				...
				if(evt.marker.patternId == 5)
				{
					 ...
					 sound5 = new Sound;
					 sound5.load(new URLRequest('./assets/sonido/letras/letra_F.mp3'));
				...
				if(evt.marker.patternId == 6)
				{
					 ...
					 sound6 = new Sound;
					 sound6.load(new URLRequest('./assets/sonido/letras/Letra_G.mp3'));
				...
				if(evt.marker.patternId == 7)
				{
					 ...
					 sound7 = new Sound;
					 sound7.load(new URLRequest('./assets/sonido/figuras/A_arbol.mp3'));
				...
				if(evt.marker.patternId == 8)
				{
					 ...
					 sound8 = new Sound;
					 sound8.load(new URLRequest('./assets/sonido/figuras/A_avion.mp3'));
				...
				if(evt.marker.patternId == 9)
				{
					 ...
					 sound9 = new Sound;
					 sound9.load(new URLRequest('./assets/sonido/figuras/B_bate.mp3'));
				...
				if(evt.marker.patternId == 10)
				{
					 ...
					 sound10 = new Sound;
					 sound10.load(new URLRequest('./assets/sonido/figuras/B_bote.mp3'));
				...
				if(evt.marker.patternId == 11)
				{
					 ...
					 sound11 = new Sound;
					 sound11.load(new URLRequest('./assets/sonido/figuras/C_carro.mp3'));
				...
				if(evt.marker.patternId == 12)
				{
					 ...
					 sound12 = new Sound;
					 sound12.load(new URLRequest('./assets/sonido/figuras/C_casa.mp3'));
				...
				if(evt.marker.patternId == 13)
				{
					 ...
					 sound13 = new Sound;
					 sound13.load(new URLRequest('./assets/sonido/figuras/D_dado.mp3'));
				...
				if(evt.marker.patternId == 14)
				{
					 ...
					 sound14 = new Sound;
					 sound14.load(new URLRequest('./assets/sonido/figuras/D_dos.mp3'));
				...
				if(evt.marker.patternId == 15)
				{
					 ...
					 sound15 = new Sound;
					 sound15.load(new URLRequest('./assets/sonido/figuras/E_escalera.mp3'));
				...
				if(evt.marker.patternId == 16)
				{
					 ...
					 sound16 = new Sound;
					 sound16.load(new URLRequest('./assets/sonido/figuras/E_estrella.mp3'));
				...
				if(evt.marker.patternId == 17)
				{
					 ...
					 sound17 = new Sound;
					 sound17.load(new URLRequest('./assets/sonido/figuras/F_flor.mp3'));
				...
				if(evt.marker.patternId == 18)
				{
					 ...
					 sound18 = new Sound;
					 sound18.load(new URLRequest('./assets/sonido/figuras/F_frutas.mp3'));
				...
				if(evt.marker.patternId == 19)
				{
					 ...
					 sound19 = new Sound;
					 sound19.load(new URLRequest('./assets/sonido/figuras/G_gato.mp3'));
				...
				if(evt.marker.patternId == 20)
				{
					 ...
					 sound20 = new Sound;
					 sound20.load(new URLRequest('./assets/sonido/figuras/G_globo.mp3'));
