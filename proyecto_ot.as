package {
	...
	public class proyecto_ot extends Sprite
	{
	...
	public function proyecto_ot()
		{
			...
			this.flarManager = new FLARManager("flarConfig_ot.xml");
        ...
        private function onFlarManagerInited (evt:Event) :void 
        {
            ...
            model.load("./assets/models/O/O.DAE"); 
            model.rotationX = 90; 
            model.rotationY = 0; 
            model.rotationZ = 90; 
            model.scale = 1; 	 
            ...
            model1.load("./assets/models/P/P.DAE"); 
            model1.rotationX = 90; 
            model1.rotationY = 0;
            model1.rotationZ = 90; 
            model1.scale = 1; 
            ...
            model2.load("./assets/models/Q/Q.DAE"); 
            model2.rotationX = 90; 
            model2.rotationY = 0;
            model2.rotationZ = 90; 
            model2.scale = 1; 
            ...
            model3.load("./assets/models/R/R.dae"); 
            model3.rotationX = 90; 
            model3.rotationY = 0;
            model3.rotationZ = 90; 
            model3.scale = 1;
			...
			model4.load("./assets/models/S/S.dae"); 
			model4.rotationX = 90; 
			model4.rotationY = 0;
			model4.rotationZ = 90; 
			model4.scale = 1;
			...
			model5.load("./assets/models/T/T.dae"); 
			model5.rotationX = 90; 
			model5.rotationY=  0;
			model5.rotationZ = 90; 
			model5.scale = 1; 
			...
			model6.load("./assets/models/figuras/olla/olla.DAE"); 
			model6.rotationX = 90; 
			model6.rotationY=  0;
			model6.rotationZ = 90; 
			model6.scale = 1; 
			...
			model7.load("./assets/models/figuras/oveja/oveja.DAE"); 
			model7.rotationX = 90; 
			model7.rotationY = 0;
			model7.rotationZ = 90; 
			model7.scale = 1; 
			...
			model8.load("./assets/models/figuras/pelota/pelota.DAE"); 
			model8.rotationX = 90; 
			model8.rotationY = 0;
			model8.rotationZ = 90; 
			model8.scale = 1; 
			...
			model9.load("./assets/models/figuras/pato/pato.dae"); 
			model9.rotationX = 90; 
			model9.rotationY = 0;
			model9.rotationZ = 180; 
			model9.scale = 1; 
			
			model10 = new DAE(true, "model10", true); 
			model10.load("./assets/models/figuras/queso/queso.dae"); 
			...
			model11.load("./assets/models/figuras/queso/queso.dae"); 
			...
			model12.load("./assets/models/figuras/reloj/reloj.dae"); 
			model12.rotationX = 90; 
			model12.rotationY = 0;
			model12.rotationZ = 90; 
			model12.scale = 1; 
			
			model13 = new DAE(true, "model13", true);
			model13.load("./assets/models/figuras/regalo/regalo.dae");
			...
			model14.load("./assets/models/figuras/silla/silla.dae");
			...
			model15.load("./assets/models/figuras/sombrero/sombrero.dae");
			...
			model16.load("./assets/models/figuras/taza/taza.DAE");
			...
			model17.load("./assets/models/figuras/tomate/tomate.DAE");
		   ...
		   private function updateP(e:KeyboardEvent):void {
			...
			private function onMarkerAdded ( evt:FLARMarkerEvent) :void
			{
					...
					if(evt.marker.patternId == 0)
					{
    						...
    						sound = new Sound;
							sound.load(new URLRequest("./assets/sonido/letras/Letra_O.mp3"));
					...
					if(evt.marker.patternId == 1)
				{
					 ...
					 sound1 = new Sound;
					 sound1.load(new URLRequest('./assets/sonido/letras/Letra_P.mp3'));
				...
				if(evt.marker.patternId == 2)
				{
					 ...
					 sound2 = new Sound;
					 sound2.load(new URLRequest('./assets/sonido/letras/Letra_Q.mp3'));
				...
				if(evt.marker.patternId == 3)
				{
					 ...
					 sound3 = new Sound;
					 sound3.load(new URLRequest('./assets/sonido/letras/Letra_R.mp3'));
				...
				if(evt.marker.patternId == 4)
				{
					 ...
					 sound4 = new Sound;
					 sound4.load(new URLRequest('./assets/sonido/letras/Letra_S.mp3'));
				...
				if(evt.marker.patternId == 5)
				{
					 ...
					 sound5 = new Sound;
					 sound5.load(new URLRequest('./assets/sonido/letras/letra_T.mp3'));
				...
				if(evt.marker.patternId == 6)
				{
					 ...
					 sound6 = new Sound;
					 sound6.load(new URLRequest('./assets/sonido/figuras/O_olla.mp3'));
				...
				if(evt.marker.patternId == 7)
				{
					 ...
					 sound7 = new Sound;
					 sound7.load(new URLRequest('./assets/sonido/figuras/O_oveja.mp3'));
				...
				if(evt.marker.patternId == 8)
				{
					 ...
					 sound8 = new Sound;
					 sound8.load(new URLRequest('./assets/sonido/figuras/P_pelota.mp3'));
				...
				if(evt.marker.patternId == 9)
				{
					 ...
					 sound9 = new Sound;
					 sound9.load(new URLRequest('./assets/sonido/figuras/P_pato.mp3'));
				...
				if(evt.marker.patternId == 10)
				{
					 ...
					 sound10 = new Sound;
					 sound10.load(new URLRequest('./assets/sonido/figuras/Q_queso.mp3'));
				...
				if(evt.marker.patternId == 11)
				{
					 ...
					 sound11 = new Sound;
					 sound11.load(new URLRequest('./assets/sonido/figuras/Q_queso.mp3'));
				...
				if(evt.marker.patternId == 12)
				{
					 ...
					 sound12 = new Sound;
					 sound12.load(new URLRequest('./assets/sonido/figuras/R_reloj.mp3'));
				...
				if(evt.marker.patternId == 13)
				{
					 ...
					 sound13 = new Sound;
					 sound13.load(new URLRequest('./assets/sonido/figuras/R_regalo.mp3'));
				...
				if(evt.marker.patternId == 14)
				{
					 ...
					 sound14 = new Sound;
					 sound14.load(new URLRequest('./assets/sonido/figuras/S_silla.mp3'));
				...
				if(evt.marker.patternId == 15)
				{
					 ...
					 sound15 = new Sound;
					 sound15.load(new URLRequest('./assets/sonido/figuras/S_sombrero.mp3'));
				...
				if(evt.marker.patternId == 16)
				{
					 ...
					 sound16 = new Sound;
					 sound16.load(new URLRequest('./assets/sonido/figuras/T_taza.mp3'));
				...
				if(evt.marker.patternId == 17)
				{
					 ...
					 sound17 = new Sound;
					 sound17.load(new URLRequest('./assets/sonido/figuras/T_tomate.mp3'));
