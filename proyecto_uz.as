package {
	...
	public class proyecto_uz extends Sprite
	{
		...
		public function proyecto_uz()
		{
			...
			this.flarManager = new FLARManager("flarConfig_uz.xml");
        ...
        private function onFlarManagerInited (evt:Event) :void 
        {
            ...
            model.load("./assets/models/U/U.DAE"); 
            model.rotationX = 90; 
            model.rotationY = 0; 
            model.rotationZ = 90; 
            model.scale = 1; 	 
            ...
            model1.load("./assets/models/V/V.dae"); 
            model1.rotationX = 90; 
            model1.rotationY = 0;
            model1.rotationZ = 90; 
            model1.scale = 1; 
            ...
            model2.load("./assets/models/W/W.dae"); 
            model2.rotationX = 90; 
            model2.rotationY = 0;
            model2.rotationZ = 90; 
            model2.scale = 1; 
            ...
            model3.load("./assets/models/X/X.dae"); 
            model3.rotationX = 90; 
            model3.rotationY = 0;
            model3.rotationZ = 90; 
            model3.scale = 1;
			...
			model4.load("./assets/models/Y/Y.DAE"); 
			model4.rotationX = 90; 
			model4.rotationY = 0;
			model4.rotationZ = 90; 
			model4.scale = 1;
			...
			model5.load("./assets/models/Z/Z.DAE"); 
			model5.rotationX = 90; 
			model5.rotationY=  0;
			model5.rotationZ = 90; 
			model5.scale = 1; 
			...
			model6.load("./assets/models/figuras/uvas/uvas.DAE"); 
			model6.rotationX = 90; 
			model6.rotationY=  0;
			model6.rotationZ = 90; 
			model6.scale = 1; 
			...
			model7.load("./assets/models/figuras/uno/UNO.DAE"); 
			model7.rotationX = 90; 
			model7.rotationY = 0;
			model7.rotationZ = 90; 
			model7.scale = 1; 
			...
			model8.load("./assets/models/figuras/vaca/vaca.dae"); 
			model8.rotationX = 90; 
			model8.rotationY = 0;
			model8.rotationZ = 180; 
			model8.scale = 1; 
			
			model9 = new DAE(true, "model9", true); 
			model9.load("./assets/models/figuras/vela/vela.dae"); 
			model9.rotationX = 90; 
			model9.rotationY = 0;
			model9.rotationZ = 0; 
			model9.scale = 1; 
			...
			model12.load("./assets/models/figuras/xilofono/xilofono.dae"); 
			...
			model13.load("./assets/models/figuras/xilofono/xilofono.dae");
			...
			model14.load("./assets/models/figuras/yogurt/yogurt.dae");
			...
			model15.load("./assets/models/figuras/yogurt/yogurt.dae");
			...
			model16.load("./assets/models/figuras/zanahoria/zanahoria.DAE");
			...
			model17.load("./assets/models/figuras/zapato/zapato.dae");
		   ...
		   private function updateP(e:KeyboardEvent):void {
			...
			private function onMarkerAdded ( evt:FLARMarkerEvent) :void
			{
					...
					if(evt.marker.patternId == 0)
					{
    						...
    						sound = new Sound;
							sound.load(new URLRequest("./assets/sonido/letras/Letra_U.mp3"));
					...
					if(evt.marker.patternId == 1)
				{
					 ...
					 sound1 = new Sound;
					 sound1.load(new URLRequest('./assets/sonido/letras/Letra_V.mp3'));
				...
				if(evt.marker.patternId == 2)
				{
					 ...
					 sound2 = new Sound;
					 sound2.load(new URLRequest('./assets/sonido/letras/Letra_W.mp3'));
				...
				if(evt.marker.patternId == 3)
				{
					 ...
					 sound3 = new Sound;
					 sound3.load(new URLRequest('./assets/sonido/letras/Letra_X.mp3'));
				...
				if(evt.marker.patternId == 4)
				{
					 ...
					 sound4 = new Sound;
					 sound4.load(new URLRequest('./assets/sonido/letras/Letra_Y.mp3'));
				...
				if(evt.marker.patternId == 5)
				{
					 ...
					 sound5 = new Sound;
					 sound5.load(new URLRequest('./assets/sonido/letras/letra_Z.mp3'));
				...
				if(evt.marker.patternId == 6)
				{
					 ...
					 sound6 = new Sound;
					 sound6.load(new URLRequest('./assets/sonido/figuras/U_uvas.mp3'));
				...
				if(evt.marker.patternId == 7)
				{
					 ...
					 sound7 = new Sound;
					 sound7.load(new URLRequest('./assets/sonido/figuras/U_uno.mp3'));
				...
				if(evt.marker.patternId == 8)
				{
					 ...
					 sound8 = new Sound;
					 sound8.load(new URLRequest('./assets/sonido/figuras/V_vaca.mp3'));
				...
				if(evt.marker.patternId == 9)
				{
					 ...
					 sound9 = new Sound;
					 sound9.load(new URLRequest('./assets/sonido/figuras/V_vela.mp3'));
				...
				if(evt.marker.patternId == 12)
				{
					 ...
					 sound12 = new Sound;
					 sound12.load(new URLRequest('./assets/sonido/figuras/X_xilofono.mp3'));
				...
				if(evt.marker.patternId == 13)
				{
					 ...
					 sound13 = new Sound;
					 sound13.load(new URLRequest('./assets/sonido/figuras/X_xilofono.mp3'));
				...
				if(evt.marker.patternId == 14)
				{
					 ...
					 sound14 = new Sound;
					 sound14.load(new URLRequest('./assets/sonido/figuras/Y_yogurt.mp3'));
				...
				if(evt.marker.patternId == 15)
				{
					 ...
					 sound15 = new Sound;
					 sound15.load(new URLRequest('./assets/sonido/figuras/Y_yogurt.mp3'));
				...
				if(evt.marker.patternId == 16)
				{
					 ...
					 sound16 = new Sound;
					 sound16.load(new URLRequest('./assets/sonido/figuras/Z_zanahoria.mp3'));
				...
				if(evt.marker.patternId == 17)
				{
					 ...
					 sound17 = new Sound;
					 sound17.load(new URLRequest('./assets/sonido/figuras/Z_zapato.mp3'));
